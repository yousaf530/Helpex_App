...
class AdvisorChat extends StatefulWidget {
  final String otherUserID;
  const AdvisorChat({Key? key, required this.otherUserID}) : super(key: key);

  @override
  State<AdvisorChat> createState() => _AlertChatState();
}

class _AlertChatState extends State<AdvisorChat> {
...
@override
  ...
  void onSendMessage(String content, int type) {
    if (content.trim().isNotEmpty) {
      ...
      WriteMessageService.sendMessageAdvisor(content,type,currentUser.uid!,widget.otherUserID,currentUser.name!);
  ...
  Widget buildListMessage() {
    return Flexible(
      child: StreamBuilder<QuerySnapshot>(
        stream: WriteMessageService.getChatStream(currentUser.uid!,widget.otherUserID,_limit),
